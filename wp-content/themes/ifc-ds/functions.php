...
<!-- wp:ifc-ds/layout-container {"containerType":"fixed","maxColumns":12} -->
    ...
    <div class="wp-block-group ifc-ds-curso-main">
        ...
        <!-- wp:ifc-ds/container {"padding":{"top":"4","right":"4","bottom":"4","left":"4"}, "margin":{"top":"5","bottom":"5"}} -->
            <!-- wp:group -->
        ...
        <section class="wp-block-group">
            ...
            <!-- wp:ifc-ds/text {"content":"Este curso é reconhecido pelo MEC por meio da portaria nº 588, 22 de outubro de 2014. É necessário que os alunos ingressantes no curso tenham o ensino médio completo.","textType":"body","weight":"regular","color":"neutral"} /-->
        </section>
        <!-- /wp:group -->
        ...
        <section class="wp-block-group">
            ...
            <!-- wp:ifc-ds/text {"content":"E-mail: sistemasdeinformacao.grad.camboriu@ifc.edu.br","textType":"body","weight":"regular","color":"neutral"} /-->
            <!-- wp:ifc-ds/text {"content":"Coordenador: Rafael de Moura Speroni","textType":"body","weight":"regular","color":"neutral"} /-->
        </section>
        <!-- /wp:group -->
    </div>
    <!-- /wp:group -->
