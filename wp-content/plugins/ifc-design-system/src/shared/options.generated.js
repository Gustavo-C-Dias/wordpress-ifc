 ...
 */
export const allColorOptions = [
    { label: __('Primary 100', 'ifc-design-system'), value: 'primary-100' },
    { label: __('Primary 200', 'ifc-design-system'), value: 'primary-200' },
    { label: __('Primary 300', 'ifc-design-system'), value: 'primary-300' },
    { label: __('Primary 400', 'ifc-design-system'), value: 'primary-400' },
    { label: __('Primary 500', 'ifc-design-system'), value: 'primary-500' },
    { label: __('Primary 600', 'ifc-design-system'), value: 'primary-600' },
    { label: __('Primary 700', 'ifc-design-system'), value: 'primary-700' },
    { label: __('Secondary 100', 'ifc-design-system'), value: 'secondary-100' },
    { label: __('Secondary 200', 'ifc-design-system'), value: 'secondary-200' },
    { label: __('Secondary 300', 'ifc-design-system'), value: 'secondary-300' },
    { label: __('Secondary 400', 'ifc-design-system'), value: 'secondary-400' },
    { label: __('Secondary 500', 'ifc-design-system'), value: 'secondary-500' },
    { label: __('Secondary 600', 'ifc-design-system'), value: 'secondary-600' },
    { label: __('Secondary 700', 'ifc-design-system'), value: 'secondary-700' },
    { label: __('Neutral 100', 'ifc-design-system'), value: 'neutral-100' },
    { label: __('Neutral 200', 'ifc-design-system'), value: 'neutral-200' },
    { label: __('Neutral 300', 'ifc-design-system'), value: 'neutral-300' },
    { label: __('Neutral 400', 'ifc-design-system'), value: 'neutral-400' },
    { label: __('Neutral 500', 'ifc-design-system'), value: 'neutral-500' },
    { label: __('Neutral 600', 'ifc-design-system'), value: 'neutral-600' },
    { label: __('Neutral 700', 'ifc-design-system'), value: 'neutral-700' }
];
