...
export const spacingOptions = [
    { label: '0', value: '0' },
    { label: '0.5 (4px)', value: '0-5' },
    { label: '1 (8px)', value: '1' },
    { label: '1.5 (12px)', value: '1-5' },
    { label: '2 (16px)', value: '2' },
    { label: '3 (24px)', value: '3' },
    { label: '4 (32px)', value: '4' },
    { label: '5 (40px)', value: '5' },
    { label: '6 (48px)', value: '6' },
    { label: '7 (56px)', value: '7' },
    { label: '8 (64px)', value: '8' },
    { label: '9 (72px)', value: '9' },
    { label: '10 (80px)', value: '10' }
];
...
export const fontFamilyOptions = [
    { label: 'Primary Font Family', value: 'primary' }
];
